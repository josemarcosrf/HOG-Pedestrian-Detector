...
%  positives probabilities to be plotted.
%
...
%  is characterized by the miss and false positives probabilities,
...
%    The x axis represents the false positives probability.
%
...
set (gca, 'xgrid', 'on');
xlabel ('False positives probability (in %)');
